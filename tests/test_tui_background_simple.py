...
class TestTUIBackgroundSimple(unittest.TestCase):
    ...
    def test_process_registration_data_structure(self):
        ...
        required_fields = ['command', 'start_time', 'last_status', 'last_line_count', 'message_widget']
    ...
    def test_process_cleanup_logic(self):
        ...
        with patch.object(self.tui.background_executor, 'get_process', return_value=None):
    ...
    def test_keyboard_shortcuts_exist(self):
        ...
        self.assertTrue(callable(getattr(self.tui, 'action_show_background_processes', None)))
        self.assertTrue(callable(getattr(self.tui, 'action_interrupt_background_processes', None)))
    ...
    def test_background_process_count_tracking(self):
        ...
        for process_id, command in processes:
            self.assertIn(process_id, self.tui.background_processes)
            self.assertEqual(
                self.tui.background_processes[process_id]['command'], 
                command
            )
