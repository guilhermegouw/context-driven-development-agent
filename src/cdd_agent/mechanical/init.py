...
def generate_cdd_md(base_path: Path, force: bool = False) -> Tuple[bool, bool]:
    ...
    if claude_md_path.exists():
        console.print("[yellow]📄 Found existing CLAUDE.md[/yellow]")
        ...
        if migrate:
            ...
            console.print("✅ Content migrated from CLAUDE.md → CDD.md")
            console.print("💡 You can now delete CLAUDE.md if desired")
...
def initialize_project(path: str, force: bool = False) -> dict:
    ...
    if git_root and git_root != target_path:
        console.print(
            f"[blue]ℹ️  Detected git repository. " f"Using git root: {git_root}[/blue]"
        )
